...
public class ReverbParams {
    ...
    public static ReverbParams getReverb0() {
        ...
        r.gainHF = 0.99f;
        r.decayHFRatio = 0.6f * SoundPhysicsConfig.General.globalReverbBrightness;
        ...
        r.roomRolloffFactor = 0.16f * SoundPhysicsConfig.General.rolloffFactor;
    ...
    public static ReverbParams getReverb1() {
        ...
        r.gainHF = 0.99f;
        r.decayHFRatio = 0.7f * SoundPhysicsConfig.General.globalReverbBrightness;
        r.reflectionsGain = 0.2f;
        r.reflectionsDelay = 0.015f;
        r.lateReverbGain = 1.26f;
        r.lateReverbDelay = 0.011f;
        r.airAbsorptionGainHF = 0.994f;
        r.roomRolloffFactor = 0.15f * SoundPhysicsConfig.General.rolloffFactor;
    ...
    public static ReverbParams getReverb2() {
        ...
        r.airAbsorptionGainHF = 0.994f;
        r.roomRolloffFactor = 0.13f * SoundPhysicsConfig.General.rolloffFactor;
    ...
    public static ReverbParams getReverb3() {
        ...
        r.lateReverbDelay = 0.021f;
        r.airAbsorptionGainHF = 0.994f;
        r.roomRolloffFactor = 0.11f * SoundPhysicsConfig.General.rolloffFactor;
